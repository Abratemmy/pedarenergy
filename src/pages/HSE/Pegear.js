            ...
            <div className='hseContainer'>
                <div className="container">
                    <div className="contactContentTop">
                        <div className="titleStroke">PEGEAR®</div>
                        <div className="subtitle"><span className="border-box"></span>PEGEAR® – Our Flagship HSE Brand</div>
                        <h2 className="pageTitle">PEGEAR® – Safety That <span>Empowers</span></h2>
                    </div>
